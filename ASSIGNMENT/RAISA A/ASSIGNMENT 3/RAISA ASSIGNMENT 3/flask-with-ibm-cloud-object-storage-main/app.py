...
COS_API_KEY_ID="YUU1qmg_kBRvtNM5ltJ1YRPzTL6KzwSreruZgPrj7-WA"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/f2df81375b9a43bdaa092e758bd9e0d1:21c7a4cb-202f-424b-9632-a4f7d7b476e2::"
...
@app.route('/')
def index():
    files = get_bucket_contents('app789')
